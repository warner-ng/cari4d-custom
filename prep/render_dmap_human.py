...
# renders the GT depth map of human mesh, an alternative for datasets where no raw depth was captured, e.g. HODome dataset.
...
class DMapRenderer(FPBehaveVideoProcessor):
    def render(self, args):
        ...
        # load packed GT data 
        packed_file = f'{args.packed_root}/{self.video_prefix}_GT-packed.pkl'
        ...
        for kid in kids:
            ...
            if args.viz_path is not None:
                viz_path = f'output/viz-render-dmap/{self.video_prefix}_k{kid}.mp4'
    ...
    def get_parser():
        ...
        parser.add_argument('--packed_root', default='data/train/packed')
        return parser
