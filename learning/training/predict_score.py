...
class ScorePredictor:
  ...
  def predict(self, rgb, depth, K, ob_in_cams, normal_map=None, get_vis=False, mesh=None, mesh_tensors=None, glctx=None, mesh_diameter=None, num_vis=25, no_text=False, rgb_only=False):
    '''
    @rgb: np array (H,W,3)
    '''
    ...
    if get_vis:
      ...
      K = num_vis
      canvas = vis_batch_data_scores(pose_data, ids=ids[:K], scores=scores, no_text=no_text)
